export const dict = {
  ...
  "settings.plugins.sort": "Sort plugins",
  "settings.plugins.sort.relevance": "Relevance",
  "settings.plugins.sort.downloads": "Downloads",
  "settings.plugins.sort.updated": "Recently updated",
  "settings.plugins.loadMore": "Load more",
  "settings.plugins.weeklyDownloads": "Weekly downloads: {{count}}",
  "settings.plugins.install": "Install",
  "settings.plugins.installed.tag": "Installed",
  "settings.plugins.update": "Update",
  "settings.plugins.updated.toast.title": "Plugin updated",
  "settings.plugins.updated.toast.description": "{{plugin}} was updated in your global configuration.",
  "settings.plugins.local": "Local",
  "settings.plugins.description": "Plugins extend the server and the terminal UI. Plugins that publish widgets render them in this app.",
  "plugin.drawer.toggle": "Toggle plugin panel",
  "plugin.drawer.empty": "No plugin widgets published",
  "settings.plugins.install.placeholder": "Package, git URL, or local path",
  "plugin.drawer.noWidgets": "No UI published",
  "plugin.drawer.errors": "Load errors",
  "plugin.drawer.openSettings": "Manage plugins",
}
